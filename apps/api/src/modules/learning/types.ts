...
export const createLessonSchema = z.object({
  ...
  position: z.number().int().min(0).default(0),
  contentType: z
    .enum(["video", "text", "pdf", "audio", "live", "quiz"])
    .default("text"),
  contentUrl: z.string().url().optional(),
  // Rich HTML body authored in the lesson editor (or generated by the AI
  // assistant). Without this field zod silently strips contentBody from the
  // payload and lesson content can never be saved through the API.
  contentBody: z.string().max(300_000).optional(),
